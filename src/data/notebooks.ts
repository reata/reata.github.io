    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            title:
              "超参调节、批量标准化、编程框架 Hyperparameter tuning, Batch Normalization and Programming Frameworks",
      ...
      },
      {
        ...
        children: [
          ...
          {
            title:
              "深度卷积模型：案例分析 Deep Convolutional Models: Case Studies",
          ...
          {
            title:
              "特殊应用：人脸识别&神经风格迁移 Special Application: Face Recognition & Neural Style Transfer",
