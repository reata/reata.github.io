...
const gists: Gist[] = [
  ...
  {
    title: "构建索引实现点查Parquet文件",
    link: "https://gist.github.com/reata/aefabfaf784ae37bd5eff44c28f7037f",
  },
  {
  ...
  {
    title:
      "在Python中查询MySQL是CPU密集型还是IO密集型任务，能用多线程来加速吗？",
  ...
  {
    title:
      "用多线程代码解释分布式JOIN策略：BroadcastHashJoin, ShuffleHashJoin, ShuffleSortMergeJoin & BroadcastNestedLoopJoin",
