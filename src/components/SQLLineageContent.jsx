...
const data = [
  ...
  },
  {
    ...
    icon: RepeatIcon,
    title: "社区动态",
    content: "SQLLineage入选PyCoder's Weekly邮件订阅",
    color: "secondary",
    variant: "filled",
  },
  {
        ...
        <Box sx={{ paddingTop: 8, paddingBottom: 6 }}>
          <Container maxWidth="sm">
            ...
            <Typography
              ...
              sx={{ mb: 2 }}
            >
              SQLLineage是一个基于Python的SQL血缘分析工具。这个包可以方便地分析任意SQL的输入表、输出表，并提供UI可视化。
            </Typography>
            <Box sx={{ marginTop: 2 }}>
            ...
            >
              ...
              {Object.entries(dimensionAttribute).map((category) => (
                <Line
                  type="monotone"
                  dataKey={category[0]}
                  stroke={strokeColors[category[0]]}
                  hide={category[1]}
                  key={category[0]}
                />
              ))}
